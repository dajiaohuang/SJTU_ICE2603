...
wire i_hamd = r_type & (func3 == 3'b111 ) & inst[30];   // hamming distance
wire i_small = r_type & (func3 == 3'b011 ) ;
...
wire i_srai = i_type & (func3 == 3'b101 ) &  inst[30]; //101,1
  ...
  wire i_jal = (op == 7'b1101111);
   ...
   assign wreg = i_add | i_sub | i_and | i_or   | i_xor  |
                 ...
                 i_ori | i_xori | i_srli | i_slli | i_srai | i_lw | i_jalr | i_lui  | i_jal | i_hamd |i_small;
   
assign aluc[3] = i_sub | i_sra | i_beq | i_bne|i_srai | i_hamd |i_small;
assign aluc[2] = i_and | i_or | i_xor | i_srl | i_sra |
                 i_andi | i_ori | i_xori | i_srli | i_srai | i_hamd |i_small                            ;  
assign aluc[1] = i_and | i_or | i_andi | i_ori |i_lui|i_hamd;
assign aluc[0] = i_and | i_srl | i_sra | i_sll |
                i_andi | i_srli | i_srai | i_slli |i_hamd ;
...
assign aluimm  = i_addi | i_andi | i_ori | i_xori | i_slli | i_srli | i_srai | i_lw | i_jalr | i_lui | i_sw;

assign m2reg = i_lw;

assign shift =  i_srl | i_sra | i_sll 
               | i_srli | i_srai | i_slli;
endmodule